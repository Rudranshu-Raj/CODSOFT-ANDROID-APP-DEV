...
setAlarmButton.addEventListener('click', ()=> {
    ...
    if(timeUntilAlarm <= 0){
        alert("Please select a future time for alarm...");
        return;
    }
    ...
    // console.log(`Alarm scheduled in ${timeUntilAlarm / 1000} seconds`);
...
function snoozeAlarm(snoozeAlarmTime) {
...
// setTimeout(() => snoozeAlarm(2), 10000);
